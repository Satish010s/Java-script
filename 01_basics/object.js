...
//  key: value
const item={
     diaryMilk:'30',  //must include comma(,) after defining 
     kitkat:"10"      //on item
}
console.log(item) // it acces the key and value both
...
//But  if we defined the the variables wth const then we can;;t change the value 
